...
* <br/>	<br/>
* <b>Note:</b> This version of the plugin is adapted to Unity version 2019.1, while for all older versions of Unity <b>unityInstance</b> in plugin's functions has to be renamed to <b>gameInstance</b>.
*<br/> <br/>
*
...
var VisageTrackerUnityPlugin = 
{
	...
	* <br/>
	*/
	mPreloadData__deps: ['data'],
	
	/*
	* Loads the script that loads the data into the Emscripten's File System from urls and names stored in {@link module:VisageTrackerUnityPlugin.data|data} array.
	* <br/>
	*/
	mPreloadData: function()
	{
	...
	* {@link module:VisageTrackerUnityPlugin.mPreloadData|mPreloadData} functions.
	* <br/>
	*/
	mInitVisage__deps: ['mInInit', 'files', 'mPreloadFiles', 'data', 'mPreloadData'],
	...
	*/
	_getTrackerStatus: function(trackStatus, length)
	{
		...
		var JavaScriptSharedArray = new Int32Array(unityInstance.Module.buffer, trackStatus, length);
	...
	*/
	_getCameraInfo: function(camFocus, imgWidth, imgHeight)
	{
		...
		var focusArray = new Float32Array(unityInstance.Module.buffer, camFocus, 1);
		var widthArray = new Int32Array(unityInstance.Module.buffer, imgWidth, 1);
		var heightArray = new Int32Array(unityInstance.Module.buffer, imgHeight, 1);
	...
	_getTexCoordsStatic: function(texCoords, texCoordNumber)
	{
		...
		var texCoordsArray       = new Float32Array(unityInstance.Module.buffer, texCoords   , 2 * faceData.faceModelVertexCount);
		var texCoordsNumberArray = new Int32Array(unityInstance.Module.buffer, texCoordNumber, 1);
	...
	*/
	_getHeadTranslation: function(translation, faceIndex)
	{
		...
		var translationArray = new Float32Array(unityInstance.Module.buffer, translation, 3);
	...
	*/
	_getHeadRotation: function(rotation, faceIndex)
	{
		...
		var rotationArray = new Float32Array(unityInstance.Module.buffer, rotation, 3);
	...
	*/
	...
	{  
		var groupSizeArrayView = new Int32Array(unityInstance.Module.buffer, groupSizeArray, length);
	...
	*/
	_getFeaturePoints3DRelative: function(N, groups, indices, positions3D, defined, detected, quality, faceIndex)
	{
		...
		var FPGroupRelView = new Int32Array(unityInstance.Module.buffer, groups, N);
		var FPIndRelView = new Int32Array(unityInstance.Module.buffer, indices, N);
		
		var FPPosRelView = new Float32Array(unityInstance.Module.buffer, positions3D, N*3);
		var FPDefRelView = new Int32Array(unityInstance.Module.buffer, defined, N);
		var FPDetRelView = new Int32Array(unityInstance.Module.buffer, detected, N);
		var FPQualRelView = new Float32Array(unityInstance.Module.buffer, quality, N);
	...
	*/
	_getFeaturePoints3D: function(N, groups, indices, positions3D, defined, detected, quality, faceIndex)
	{
        ...
        var FPGroupView = new Int32Array(unityInstance.Module.buffer, groups, N);
		var FPIndView = new Int32Array(unityInstance.Module.buffer, indices, N);
		
		var FPPosView = new Float32Array(unityInstance.Module.buffer, positions3D, N*3);
		var FPDefView = new Int32Array(unityInstance.Module.buffer, defined, N);
		var FPDetView = new Int32Array(unityInstance.Module.buffer, detected, N);
		var FPQualView = new Float32Array(unityInstance.Module.buffer, quality, N);
	...
	*/
	_getFeaturePoints2D: function(N, groups, indices, positions2D, defined, detected, quality, faceIndex)
	{
		...
		var FPPosView = new Float32Array(unityInstance.Module.buffer, positions2D, N*2);
		var FPDefView = new Int32Array(unityInstance.Module.buffer, defined, N);
		var FPDetView = new Int32Array(unityInstance.Module.buffer, detected, N);
		var FPQualView = new Float32Array(unityInstance.Module.buffer, quality, N);
	...
	*/
	_getAllFeaturePoints3DRelative: function(featurePointArray, length, faceIndex)
	{
		...
		var FeaturePointsView = new Float32Array(unityInstance.Module.buffer, featurePointArray, length);
	...
	*/
	_getFaceModelVertices: function(vertices, faceIndex)
	{
		...
		var verticesArrayView = new Float32Array(unityInstance.Module.buffer, vertices, vertexNumber*3);
	...
	*/
	_getFaceModelVerticesProjected: function(verticesProjected, faceIndex)
	{
		...
		var verticesProjectedArray = new Float32Array(unityInstance.Module.buffer, verticesProjected, vertexNumber*2);
	...
	*/
	_getFaceModelTriangles: function(triangles, faceIndex)
	{
		...
		var trianglesArray = new Int32Array(unityInstance.Module.buffer, triangles, triangleNumber*3);
	...
	*/
	_getFaceModelTextureCoords: function(texCoord, faceIndex)
	{
		...
		var texCoordArray = new Float32Array(unityInstance.Module.buffer, texCoord, vertexNumber*2);
	...
	*/
	...
	{
		var config = Pointer_stringify(trackerConfigFile);
	...
	*/
	...
	{	
		...
		var indexView = new Int32Array(unityInstance.Module.buffer, index, 1);
		var gazeView = new Float32Array(unityInstance.Module.buffer, gaze, 2);
		var qualityView = new Float32Array(unityInstance.Module.buffer, quality, 1);
		var inStateView = new Int32Array(unityInstance.Module.buffer, inState, 1);
	...
	*/
	_getEyeClosure: function(closure, faceIndex)
	{
		...
		var closureView = new Float32Array(unityInstance.Module.buffer, closure, 2);
	...
	*/
	...
	{
		var radiusView = new Float32Array(unityInstance.Module.buffer, radius, 2);
	...
	*/
	_getActionUnits: function(actionUnits, faceIndex)
	{
		...
		var actionUnitsView = new Float32Array(unityInstance.Module.buffer, actionUnits, auCount);
	...
	*/
	_getGazeDirectionGlobal: function(gazeDirection, faceIndex)
	{
		...
		var gazeDirectionGlobalView = new Float32Array(unityInstance.Module.buffer, gazeDirection, 3);
	...
	*/
	_getGazeDirection: function(gazeDirection, faceIndex)
	{
		...
		var gazeDirectionView = new Float32Array(unityInstance.Module.buffer, gazeDirection, 2);
