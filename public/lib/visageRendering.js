...
{
	var faceTranslation = fd.getFaceTranslation();
	var faceRotation = fd.getFaceRotation();
	//
	var translationX = faceTranslation[0];
	var translationY = faceTranslation[1];
	var translationZ = faceTranslation[2];
	//
	var rotationX = faceRotation[0]; 
	var rotationY = faceRotation[1]; 
	var rotationZ = faceRotation[2]; 
	//
	var head_pitch_compensated_rad = rotationX - Math.atan2(translationY, translationZ);
	var head_yaw_compensated_rad = rotationY - Math.atan2(translationX, translationZ);
	var head_roll_rad = rotationZ;
	//
